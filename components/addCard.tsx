...
export default function AddCard() {
    ...
    return (
        <TouchableOpacity onPress={() => { router.push('/(perfil)/adicionar-cartao')}} className="bg-white rounded-xl flex items-center justify-center p-3 w-[130px] h-[100px] shadow-md" style={{ marginHorizontal: 6, marginVertical:10}}>
