      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View className="flex">
          ...
          <View className="relative w-auto">
            <Svg width={width} height={width} viewBox="0 0 430 307" fill="none">
              ...
              >
                ...
                <Image
                  href={require("./../../assets/images/cadastroTRES.png")}
                  width={width * 0.7}
                  height={width * 0.8}
                  x={width * 0.2}
                  y={40}
          ...
          <View className="ml-10 mr-10 justify-center items-center text-center">
            {/* Botão "Cadastrar-se" */}
            <Text className="font-PoppinsSemiBold font-semibold text-preto text-4xl mb-2 text-center justify-center items-center">
              Crie a sua conta
            </Text>
