          ...
          <View className="relative w-auto">
            <Svg width={width} height={width} viewBox="0 0 430 307" fill="none">
              ...
              <View style={{ marginTop: 200 }}>
                <Text className="ml-10 font-poppins font-semibold text-preto text-4xl">
                  Login
                </Text>
              </View>
            </Svg>
          ...
          <View className="ml-10 mr-10 mt-[-40px]">
                ...
                {({
                  ...
                  <>
                    ...
                    <View style={styles.inputWrapper}>
                      ...
                      >
                        <Path
                          d="M21 10.5H12.65C11.83 8.17 9.61 6.5 7 6.5C3.69 6.5 1 9.19 1 12.5C1 15.81 3.69 18.5 7 18.5C9.61 18.5 11.83 16.83 12.65 14.5H13L15 16.5L17 14.5L19 16.5L23 12.46L21 10.5ZM7 15.5C5.35 15.5 4 14.15 4 12.5C4 10.85 5.35 9.5 7 9.5C8.65 9.5 10 10.85 10 12.5C10 14.15 8.65 15.5 7 15.5Z"
                          fill="#FD765E"
                        />
                      </Svg>
            ...
            <View className="flex justify-center items-center">
              <Pressable onPress={handlePress} style={styles.button}>
                <Text
                  className={`font-PoppinsSemiBold text-lg justify-center text-center text-laranja`}
                >
                  Cadastre-se
                </Text>
              </Pressable>
            ...
            <Text className="text-laranja justify-center text-center font-PoppinsRegular">
              ou
            </Text>
          </View>
