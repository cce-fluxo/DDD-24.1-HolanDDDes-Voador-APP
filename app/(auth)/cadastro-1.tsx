      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View className="flex">
          ...
          <View className="ml-10 mr-10 justify-center items-center text-center">
            {/* Botão "Cadastrar-se" */}
            <Text className="font-PoppinsSemiBold text-preto text-4xl mb-2 text-center justify-center items-center">
              Crie a sua conta
            </Text>
                  ...
                  <>
                    ...
                    {isDatePickerVisible && (
                      <DateTimePicker
                        ...
                        display="default"
                        onChange={(event, date) =>
                          handleConfirm(event, date, setFieldValue)
                        }
                        is24Hour={true}
